...
public class WheelView extends View {
     ...
     */
    private int ADDITIONAL_ITEM_HEIGHT = 35;
    ...
    private void initData(Context context) {
        ...
        //数字大小
        TEXT_SIZE = getResources().getDimensionPixelSize(R.dimen.text_size18);
        //间距
        ADDITIONAL_ITEM_HEIGHT = getResources().getDimensionPixelOffset(R.dimen.whell_item_hegith);
    }
...
//                - ADDITIONAL_ITEM_HEIGHT;  update by plus
...
//		canvas.drawRect(0, center + offset, getWidth(), getHeight(), paint);
        paint.setColor(getResources().getColor(R.color.base_line_bg));
